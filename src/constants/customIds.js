module.exports = {
  ACCEPT_RULES: "rules:accept",
  NEED_HELP: "rules:help",
  TICKET_SELECT: "ticket:type",
  ...
  APPLICATION_INTERVIEW_PREFIX: "application:interview:",
  ANONYMOUS_MODAL: "anonymous:modal"
};
